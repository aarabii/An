...
import { DocumentTextIcon, RocketIcon, LinkIcon, JoystickIcon, BookIcon, StarIcon } from '@sanity/icons'
...
export const structure: StructureResolver = (S) =>
  S.list()
    ...
    .items([
      ...
      S.documentTypeListItem('resource').title('Resources').icon(LinkIcon),
      S.divider(),
      S.listItem()
      ...
      ...S.documentTypeListItems().filter(
        (listItem) => !['project', 'post', 'resource', 'game', 'book'].includes(listItem.getId() || '')
      ),
    ])
