        ...
        {CATEGORIES.map((category) => {
          ...
          return (
            <Button
              ...
              className="gap-1.5 font-para text-xs"
            >
              <span>{category}</span>
              <Badge
                variant="outline"
                className="ml-0.5 border-border font-mono text-[0.6875rem] px-1.5 py-0 h-4"
              >
                {count}
              </Badge>
            </Button>
          ...
          {goatGames.length > 0 && (
            <div className="flex flex-col gap-4">
              <div className="flex items-center justify-between border-b border-border pb-2">
                <h3 className="font-heading text-sm font-semibold tracking-tight uppercase text-muted-foreground">
